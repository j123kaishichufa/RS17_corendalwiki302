...
/**
 * AbstractStandardContentRuleType is the abstract class handling information
 * about each content rule type of the application.
 * 
 * @version $Id: AbstractStandardContentRuleType.java,v 1.1 2005/09/06 21:25:34
 *          tdanard Exp $
 */
public abstract class AbstractStandardContentRuleType extends
        AbstractContentRuleType implements Cloneable, StandardContentRuleType {
     ...
     * 
     */
    protected AbstractStandardContentRuleType() {
        // no initialization required
    }

    /**
     * Returns a clone. Overrides AbstractContentRuleType.clone.
     */
    @Override
    public Object clone() {
        return (AbstractStandardContentRuleType) super.clone();
    }
    ...
    public String getRelativeLocation() {
        return EntityUtil
                .getRelativeLocation(
                        ...
                        HTTPParameterConstants.CONTENT_RULE_TYPE_ID, this
...
// end AbstractStandardContentRuleType
