...
/**
 * AbstractArticleSubscribersBlock is the class describing and printing the
 * lkist of article subscribers.
 * 
 * @version $Id: AbstractArticleSubscribersBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractArticleSubscribersBlock extends
        AbstractSubscribersBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead.
     */
    protected AbstractArticleSubscribersBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleSubscribersBlock) super.clone();
    }
...
// end AbstractArticleSubscribersBlock
