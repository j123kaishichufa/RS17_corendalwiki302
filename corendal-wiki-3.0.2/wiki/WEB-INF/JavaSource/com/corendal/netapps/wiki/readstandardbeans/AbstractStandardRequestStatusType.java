...
import com.corendal.netapps.wiki.readdatabeans.AbstractRequestStatusType;

/**
 * AbstractStandardRequestStatusType is the abstract class handling information
 * about each request status type of the application.
 * 
 * @version $Id: AbstractStandardRequestStatusType.java,v 1.1 2005/09/06
 *          21:25:34 tdanard Exp $
 */
public abstract class AbstractStandardRequestStatusType extends
        AbstractRequestStatusType implements Cloneable,
        StandardRequestStatusType {
     ...
     * 
     */
    protected AbstractStandardRequestStatusType() {
        // no initialization required
    }

    /**
     * Returns a clone. Overrides AbstractRequestStatusType.clone.
     */
    @Override
    public Object clone() {
        return (AbstractStandardRequestStatusType) super.clone();
    }
    ...
    public String getRelativeLocation() {
        return EntityUtil
                .getRelativeLocation(
                        ...
                        HTTPParameterConstants.REQUEST_STATUS_TYPE_ID, this
...
// end AbstractStandardRequestStatusType
