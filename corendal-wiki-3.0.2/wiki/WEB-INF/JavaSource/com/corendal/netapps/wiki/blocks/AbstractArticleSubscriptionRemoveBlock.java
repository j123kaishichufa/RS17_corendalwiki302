...
/**
 * AbstractArticleSubscriptionRemoveBlock is the abstract block creating a new
 * article through a form.
 * 
 * @version $Id: AbstractArticleSubscriptionRemoveBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractArticleSubscriptionRemoveBlock extends
        AbstractArticleSubscriptionEntryBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead.
     */
    protected AbstractArticleSubscriptionRemoveBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleSubscriptionRemoveBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
         ...
         */
        this.setAccessType(AccessTypeConstants.REMOVE);
        ...
        if (sd != null) {
            /*
             * find the editor of this article
             */
            StandardAccount editor = sd.getEditorStandardAccount();

            /*
             * set the default values
             */
            if ((editor != null)
                    && (!(pm.getIsAtLeastLimitedProxy(sa.getPrimaryKey(),
                            editor.getPrimaryKey())))) {
    ...
    public void validateExtra() throws IOException {
        this.validateExtraRemoveRecord();
    }
}

// end AbstractArticleSubscriptionRemoveBlock
