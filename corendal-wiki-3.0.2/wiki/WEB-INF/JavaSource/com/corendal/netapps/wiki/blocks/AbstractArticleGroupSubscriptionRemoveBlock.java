...
/**
 * AbstractArticleGroupSubscriptionRemoveBlock is the abstract block creating a
 * new article through a form.
 * 
 * @version $Id: AbstractArticleGroupSubscriptionRemoveBlock.java,v 1.1
 *          2005/09/06 21:25:28 tdanard Exp $
 */
public abstract class AbstractArticleGroupSubscriptionRemoveBlock extends
     ...
     */
    protected AbstractArticleGroupSubscriptionRemoveBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleGroupSubscriptionRemoveBlock) super.clone();
    }
...
// end AbstractArticleGroupSubscriptionRemoveBlock
