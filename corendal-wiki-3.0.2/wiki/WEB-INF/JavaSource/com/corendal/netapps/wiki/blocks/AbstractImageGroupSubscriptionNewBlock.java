...
/**
 * AbstractImageGroupSubscriptionNewBlock is the abstract block creating a new
 * article through a form.
 * 
 * @version $Id: AbstractImageGroupSubscriptionNewBlock.java,v 1.1 2005/09/06
 *          21:25:27 tdanard Exp $
 */
public abstract class AbstractImageGroupSubscriptionNewBlock extends
     ...
     */
    protected AbstractImageGroupSubscriptionNewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractImageGroupSubscriptionNewBlock) super.clone();
    }
...
// end AbstractImageGroupSubscriptionNewBlock
