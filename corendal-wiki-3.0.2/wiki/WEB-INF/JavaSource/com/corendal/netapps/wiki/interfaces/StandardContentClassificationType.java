...
/**
 * @version $Id: StandardContentClassificationType.java,v 1.1 2005/09/06
 *          21:25:29 tdanard Exp $
 */
public interface StandardContentClassificationType extends
        ContentClassificationType, StandardReadBean, Named, Described,
        Commented, DescribedShort, DescribedLong, Located, Matched {
    /** Fully qualified name of this interface. */
    public static final String INTERFACE_NAME = "com.corendal.netapps.wiki.interfaces.StandardContentClassificationType";
}

// end StandardContentClassificationType
