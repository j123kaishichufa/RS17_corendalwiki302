...
import com.corendal.netapps.wiki.readdatabeans.AbstractContentType;

/**
 * AbstractStandardContentType is the abstract class handling information about
 * each role of the application.
 * 
 * @version $Id: AbstractStandardContentType.java,v 1.1 2005/09/06 21:25:34
 *          tdanard Exp $
 */
public abstract class AbstractStandardContentType extends AbstractContentType
        implements Cloneable, StandardContentType {
     ...
     * 
     */
    protected AbstractStandardContentType() {
        // parent class constructor is called
    }

    /**
     * Returns a clone. Overrides AbstractContentType.clone.
     */
    @Override
    public Object clone() {
        return (AbstractStandardContentType) super.clone();
    }
    ...
    public String getRelativeLocation() {
        return EntityUtil.getRelativeLocation(PrimaryKeyUtil
                .getAlphanumericSingleKey(EntitiesDictionary.CONTENT_TYPES),
                HTTPParameterConstants.CONTENT_TYPE_ID, this.getPrimaryKey()
                        .toString());
    }
    ...
    public String getDefaultLocation() {
        return EntityUtil.getDefaultLocation(PrimaryKeyUtil
                .getAlphanumericSingleKey(EntitiesDictionary.CONTENT_TYPES),
                HTTPParameterConstants.CONTENT_TYPE_ID, this.getPrimaryKey()
                        .toString());
    }
    ...
    public String getAbsoluteLocation() {
        return EntityUtil.getAbsoluteLocation(PrimaryKeyUtil
                .getAlphanumericSingleKey(EntitiesDictionary.CONTENT_TYPES),
                HTTPParameterConstants.CONTENT_TYPE_ID, this.getPrimaryKey()
                        .toString());
    }
...
// end AbstractStandardContentType
