...
/**
 * AbstractAnyEditorshipsViewBlock is the class describing and printing all
 * articles of an editor.
 * 
 * @version $Id: AbstractAnyEditorshipsViewBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractAnyEditorshipsViewBlock extends
     ...
     */
    protected AbstractAnyEditorshipsViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractAnyEditorshipsViewBlock) super.clone();
    }
    ...
    protected List getContentsFound() {
         ...
         */
        PrimaryKey editorPk = this.getRecordPrimaryKey();
...
// end AbstractAnyEditorshipsViewBlock
