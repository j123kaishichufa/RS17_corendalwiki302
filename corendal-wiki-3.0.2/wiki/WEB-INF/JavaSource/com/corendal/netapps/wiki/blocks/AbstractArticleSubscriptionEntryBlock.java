...
/**
 * AbstractArticleSubscriptionEntryBlock is the parent block common to all
 * article viewing blocks.
 * 
 * @version $Id: AbstractArticleSubscriptionEntryBlock.java,v 1.1 2005/09/06
 *          21:25:27 tdanard Exp $
 */
public abstract class AbstractArticleSubscriptionEntryBlock extends
        AbstractCommonContentEntryBlock implements Cloneable {
    /** Fully qualified name of this class. */
    private static final String ABSTRACT_CLASS_NAME = "com.corendal.netapps.wiki.blocks.AbstractArticleSubscriptionEntryBlock";
     ...
     */
    protected AbstractArticleSubscriptionEntryBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleSubscriptionEntryBlock) super.clone();
    }
        ...
        if (this.getAccessType().equals(AccessTypeConstants.NEW)) {
            ...
            if (resm.getIsRecursiveProxyOrAssociateEditor(sa.getPrimaryKey(),
                ...
                List<StandardAccount> subscribersToAdd = ContentUtil
                        .getAccountsLeftToSubscribeByRequestor(sa, articlePk);
            ...
            if (resm.getIsRecursiveProxyOrAssociateEditor(sa.getPrimaryKey(),
                ...
                List<StandardAccount> subscribersToRemove = ContentUtil
                        .getAccountsLeftToUnsubscribeByEditor(articlePk);
                ...
                List<StandardAccount> subscribersToRemove = ContentUtil
                        .getAccountsLeftToUnsubscribeByRequestor(sa, articlePk);
    ...
    protected void buildNewRecord() {
         ...
         */
        if ((article.getIsFound()) && (article.getIsAccessible())) {
            ...
            if (resm.getIsRecursiveProxyOrAssociateEditor(sa.getPrimaryKey(),
                ...
                List<StandardAccount> subscribers = ContentUtil
                        .getAccountsLeftToSubscribeByRequestor(sa, article
                                .getPrimaryKey());
                ...
                if (subscribers.size() == 0) {
                    ...
                    // 1
                    // line
                    PrimaryKey youAlreadyArticleSubscriberPk = PrimaryKeyUtil
                            .getAlphanumericSingleKey(MessagesDictionary.ERR_YOU_ALREADY_INDIVIDUAL_ARTICLE_SUBSCRIBER);
                    StandardFormMessage youAlreadyArticleSubscriberMessage = (StandardFormMessage) sfmf
                            .findByPrimaryKey(youAlreadyArticleSubscriberPk);
                    StandardMessage articleMessage = youAlreadyArticleSubscriberMessage
                            .getStandardMessage();
                    articleMessage.replaceMessageText(article.getNameText(), 1);
                    articleMessage.replaceMessageEncoded(article
                            .getNameEncoded(), 1);
                    articleMessage.replaceMessageHTML(article.getNameHTML(), 1);
                    this.addStandardFormObject(
                            youAlreadyArticleSubscriberMessage, 1, 1);
                } else {
                    this.build();
                }
            }
    ...
    protected void buildRemoveRecord() {
        ...
        if ((article.getIsFound()) && (article.getIsAccessible())) {
            ...
            if (resm.getIsRecursiveProxyOrAssociateEditor(sa.getPrimaryKey(),
                ...
                /*
                 * verify that the article has been subscribed to
                 */
                if (contentSubscriptions.size() > 0) {
                    ...
                    // 1
                    // line
                    PrimaryKey noArticleSubscriberPk = PrimaryKeyUtil
                            .getAlphanumericSingleKey(MessagesDictionary.ERR_NO_INDIVIDUAL_ARTICLE_SUBSCRIBER);
                    StandardFormMessage noArticleSubscriberMessage = (StandardFormMessage) sfmf
                            .findByPrimaryKey(noArticleSubscriberPk);
                    StandardMessage articleMessage = noArticleSubscriberMessage
                            .getStandardMessage();
                    articleMessage.replaceMessageText(article.getNameText(), 1);
                    articleMessage.replaceMessageEncoded(article
                            .getNameEncoded(), 1);
                    articleMessage.replaceMessageHTML(article.getNameHTML(), 1);
                    this
                            .addStandardFormObject(noArticleSubscriberMessage,
                                    1, 1);
                }
            } else {
                /*
                 ...
                 */
                List<StandardAccount> subscribers = ContentUtil
                        .getAccountsLeftToUnsubscribeByRequestor(sa, article
                                .getPrimaryKey());
                ...
                if (subscribers.size() == 0) {
                    ...
                    // line
                    PrimaryKey noArticleSubscriberPk = PrimaryKeyUtil
                            .getAlphanumericSingleKey(MessagesDictionary.ERR_YOU_NOT_INDIVIDUAL_ARTICLE_SUBSCRIBER);
                    StandardFormMessage noArticleSubscriberMessage = (StandardFormMessage) sfmf
                            .findByPrimaryKey(noArticleSubscriberPk);
                    StandardMessage articleMessage = noArticleSubscriberMessage
                            .getStandardMessage();
    ...
    public void validateExtraNewRecord() throws IOException {
        ...
        if (this.getIsValid()) {
            ...
            if (content.getIsDirectlySubscribedByIndividual(subscriberPk)) {
                 ...
                 */
                PrimaryKey errorPk = PrimaryKeyUtil
                        .getAlphanumericSingleKey(MessagesDictionary.ERR_ALREADY_INDIVIDUAL_ARTICLE_SUBSCRIBER);
                StandardMessage error = (StandardMessage) smf
                        .findByPrimaryKey(errorPk);
        ...
        if (this.getIsValid()) {
            ...
            contentSubscription = (StandardContentSubscription) srsf
                    .create(article.getPrimaryKey(), individualTypesPk,
                            immediateModePk);
    ...
    public void validateExtraRemoveRecord() throws IOException {
        ...
        if (this.getIsValid()) {
            ...
            if (!(content.getIsDirectlySubscribedByIndividual(subscriberPk))) {
                 ...
                 */
                PrimaryKey errorPk = PrimaryKeyUtil
                        .getAlphanumericSingleKey(MessagesDictionary.ERR_NOT_INDIVIDUAL_ARTICLE_SUBSCRIBER);
                StandardMessage error = (StandardMessage) smf
                        .findByPrimaryKey(errorPk);
        ...
        if (this.getIsValid()) {
            List<StandardContentSubscription> contentSubscriptions = srsf
                    .findEnabledByContentAndIndividualSubscriberPrimaryKeys(
                            article.getPrimaryKey(), subscriber.getPrimaryKey());
...
// end AbstractArticleSubscriptionEntryBlock
