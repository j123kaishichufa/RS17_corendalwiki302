...
/**
 * AbstractImageGroupSubscriptionRemoveBlock is the abstract block creating a
 * new article through a form.
 * 
 * @version $Id: AbstractImageGroupSubscriptionRemoveBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractImageGroupSubscriptionRemoveBlock extends
        AbstractImageGroupSubscriptionEntryBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead.
     */
    protected AbstractImageGroupSubscriptionRemoveBlock() {
        // parent class constructor is called
    }

    /**
     * Returns a clone. Overrides
     * AbstractImageGroupSubscriptionEntryBlock.clone.
     */
    @Override
    public Object clone() {
        return (AbstractImageGroupSubscriptionRemoveBlock) super.clone();
    }
...
// end AbstractImageGroupSubscriptionRemoveBlock
