...
/**
 * AbstractMyContentRequestsViewBlock is the class describing and printing all
 * content requests of a requestor.
 * 
 * @version $Id: AbstractMyContentRequestsViewBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractMyContentRequestsViewBlock extends
     ...
     */
    protected AbstractMyContentRequestsViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractMyContentRequestsViewBlock) super.clone();
    }
    ...
    protected List getContentRequestsFound() {
        ...
        /*
         * find the requestor being viewed
         */
        ...
        PrimaryKey requestorPk = sa.getPrimaryKey();
...
// end AbstractMyContentRequestsViewBlock
