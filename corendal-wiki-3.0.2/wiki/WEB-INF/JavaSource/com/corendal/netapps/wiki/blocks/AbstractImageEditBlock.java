...
/**
 * AbstractImageEditBlock is the abstract block creating a new Image through a
 * form.
 * 
 * @version $Id: AbstractImageEditBlock.java,v 1.1 2005/09/06 21:25:27 tdanard
 *          Exp $
 */
public abstract class AbstractImageEditBlock extends AbstractImageEntryBlock
     ...
     */
    protected AbstractImageEditBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractImageEditBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        ...
        /*
         * get the edit image upload page
         */
        PrimaryKey pagePk = PrimaryKeyUtil
                .getAlphanumericSingleKey(PagesDictionary.UPLOAD_IMAGE_TO_EDIT);
         ...
         */
        this.setAccessType(AccessTypeConstants.EDIT);
        ...
        if (sp != null) {
             ...
             */
            PrimaryKey parentArticlePk = sp.getMainParentPrimaryKey();
