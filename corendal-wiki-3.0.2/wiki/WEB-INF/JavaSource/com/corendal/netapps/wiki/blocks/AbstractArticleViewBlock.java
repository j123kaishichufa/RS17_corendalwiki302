...
import com.corendal.netapps.framework.core.interfaces.NavigationBar;
...
/**
 * AbstractArticleViewBlock is the class describing and printing all contents of
 * an article.
 * 
 * @version $Id: AbstractArticleViewBlock.java,v 1.1 2005/09/06 21:25:28 tdanard
 *          Exp $
 */
public abstract class AbstractArticleViewBlock extends AbstractStandardBlock
     ...
     */
    protected AbstractArticleViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleViewBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        ...
        if (article != null) {
             ...
             */
            NavigationBar pn = cm.getNavigationBar();
            StandardArticle firstArticle = article
                    .getFirstSiblingStandardArticle();

            if (firstArticle != null) {
                pn.addFirst(firstArticle.getNameText(), firstArticle
                        .getDefaultLocation());
            }

            StandardArticle previousArticle = article
                    .getPreviousSiblingStandardArticle();

            if (previousArticle != null) {
                pn.addPrevious(previousArticle.getNameText(), previousArticle
                        .getDefaultLocation());
            }

            StandardArticle nextArticle = article
                    .getNextSiblingStandardArticle();

            if (nextArticle != null) {
                pn.addNext(nextArticle.getNameText(), nextArticle
                        .getDefaultLocation());
            }

            StandardArticle lastArticle = article
                    .getLastSiblingStandardArticle();

            if (lastArticle != null) {
                pn.addLast(lastArticle.getNameText(), lastArticle
                        .getDefaultLocation());
            }
        }
    }
    ...
    public void printBodyWithoutAuthenticationCheck() {
         ...
         * print the body
         */
        aw.printBodyHTML(article, this.getHomeArticlePrimaryKey(), this, false);
    }
}

// end AbstractArticleViewBlock
