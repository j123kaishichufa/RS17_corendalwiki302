...
/**
 * ResourceRuleTypeElements is the class storing all content rule type element
 * names.
 * 
 * @version $Id: ContentRuleTypeElements.java,v 1.1 2005/09/06 21:25:29 tdanard
 *          Exp $
 */

public class ContentRuleTypeElements {
    /** Name of the collection element. */
    public static final String COLLECTION = "contentruletypes";

    /** Name of the entity element. */
    public static final String ENTITY = "contentruletype";
     ...
     */
    private ContentRuleTypeElements() {
