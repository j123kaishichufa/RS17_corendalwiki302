...
import com.corendal.netapps.wiki.readdataelements.ContentSubscriptionTypeElements;

/**
 * AbstractContentSubscriptionTypeLoadHandler is the abstract class processing
 * XML entities representing a content subscription type found after a load
 * query.
 * 
 * @version $Id: AbstractContentSubscriptionTypeLoadHandler.java,v 1.1
 *          2005/09/06 21:25:33 tdanard Exp $
 */
public abstract class AbstractContentSubscriptionTypeLoadHandler extends
        AbstractLoadHandler implements ContentSubscriptionTypeLoadHandler {
    /** Name in the content subscription type XML entity. */
    private StringBuilder name;

    /** Description in the content subscription type XML entity. */
    private StringBuilder description;

    /** Comment in the content subscription type XML entity. */
    private StringBuilder comment;

    /** Order in the content subscription type XML entity. */
    private int order;

    /** Enabled-flag in the content subscription type XML entity. */
     ...
     */
    protected AbstractContentSubscriptionTypeLoadHandler() {
        // parent class constructor is called
    }

    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionTypeLoadHandler#getName()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionTypeLoadHandler#getDescription()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionTypeLoadHandler#getComment()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionTypeLoadHandler#getOrder()
     */
    public int getOrder() {
        return this.order;
    }
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionTypeLoadHandler#getEnabledFlag()
     */
    ...
    protected void processElement(String namespaceUri, String localName,
        ...
        super.processElement(namespaceUri, localName, qualifiedName,
                attributes, isStart);
        if (qualifiedName.equals(ContentSubscriptionTypeElements.ENTITY)) {
            if (isStart) {
                this.enabledFlag = this.getStringAttributeValue(attributes,
                        ContentSubscriptionTypeElements.ENABLED_FLAG);
                this.order = this.getIntegerAttributeValue(attributes,
                        ContentSubscriptionTypeElements.ORDER);
            }
        } else if (qualifiedName.equals(ContentSubscriptionTypeElements.NAME)) {
            this.isNameCollected = isStart;
        } else if (qualifiedName
                .equals(ContentSubscriptionTypeElements.DESCRIPTION)) {
            this.isDescriptionCollected = isStart;
        } else if (qualifiedName
                .equals(ContentSubscriptionTypeElements.COMMENT)) {
