...
/**
 * AbstractContentRequestEditBlock is the abstract block printing the
 * information of content request in edit mode.
 * 
 * @version $Id: AbstractContentRequestEditBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractContentRequestEditBlock extends
     ...
     */
    protected AbstractContentRequestEditBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractContentRequestEditBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        ...
        /*
         * set the content request to edit
         */
        StandardContentRequest srr = getViewedContentRequest();
        ...
        if (srr != null) {
             ...
             */
            this.setStandardContentRequest(srr);
        } else {
            /*
...
// end AbstractContentRequestEditBlock
