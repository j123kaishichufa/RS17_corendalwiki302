...
import com.corendal.netapps.wiki.interfaces.ContentRuleType;
import com.corendal.netapps.wiki.interfaces.ContentRuleTypeLoadHandler;
import com.corendal.netapps.wiki.readdatahandlers.DefaultContentRuleTypeLoadHandler;

/**
 * AbstractContentRuleType is the abstract class retrieving information about
 * each content rule type of the application from the database.
 * 
 * @version $Id: AbstractContentRuleType.java,v 1.1 2005/09/06 21:25:34 tdanard
 *          Exp $
 */
public abstract class AbstractContentRuleType extends AbstractReadDataBean
        implements Cloneable, ContentRuleType {
    /** Fully qualified name of this class. */
    private static final String ABSTRACT_CLASS_NAME = "com.corendal.netapps.wiki.readdatabeans.AbstractContentRuleType";
    ...
    /** Nam in the content rule type table */
    private String name;

    /** Dsc in the content rule type table */
    private String description;

    /** Cmnt in the content rule type table */
    private String comment;

    /** Order in the content rule type table */
    private int order;

    /** Enabled_flag in the content rule type table */
    private String enabledFlag;

    /**
     * Default class constructor.
     */
    protected AbstractContentRuleType() {
    ...
    @Override
    public Object clone() {
        return (AbstractContentRuleType) super.clone();
    }

    /**
     * Returns a new instance of a content rule type load handler
     * 
     * @return a com.corendal.netapps.wiki.interfaces.ContentRuleTypeLoadHandler
     *         object
     */
    protected ContentRuleTypeLoadHandler getContentRuleTypeLoadHandlerNewInstance() {
        return new DefaultContentRuleTypeLoadHandler();
    }
    ...
    public void load() {
        ...
        /*
         * get the primary key of the content rule type
         */
        PrimaryKey recordPk = this.getPrimaryKey();

        try {
            /*
             * load the content rule type handler
             */
            ContentRuleTypeLoadHandler handler = this
                    .getContentRuleTypeLoadHandlerNewInstance();
            handler = (ContentRuleTypeLoadHandler) ds
                    .getLoadHandlerUsingReadLoadHandlerCache(
                            handler.getClass(), recordPk.toString());

            /*
             * retrieve the content rule type information from the database
             */
            if (handler != null) {
            ...
            PrimaryKey entityPk = PrimaryKeyUtil
                    .getAlphanumericSingleKey(EntitiesDictionary.CONTENT_RULE_TYPES);
            LoggerUtil.logError(ABSTRACT_CLASS_NAME, e, entityPk, recordPk);
        }
    }

    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleType#getName()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleType#getDescription()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleType#getComment()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleType#getOrder()
     */
    public int getOrder() {
        return this.order;
    }
    ...
    /**
     * Returns the ordered list of all content rule type primary keys.
     * 
     * @param enabledFlag
    ...
    public static final List<PrimaryKey> findByEnabledFlag(String enabledFlag) {
        ...
        /*
         * return all content rule type primary keys
         */
        return primaryKeys;
    }

    /**
     * Returns the ordered list of all content rule type primary keys for a
     * keyword.
     * 
     * @param keyword
     *            keyword to find
