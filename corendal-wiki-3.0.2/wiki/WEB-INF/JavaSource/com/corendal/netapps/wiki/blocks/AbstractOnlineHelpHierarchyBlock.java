...
/**
 * AbstractOnlineHelpHierarchyBlock is the class describing and printing the
 * online help.
 * 
 * @version $Id: AbstractOnlineHelpHierarchyBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractOnlineHelpHierarchyBlock extends
        AbstractArticleHierarchyBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead.
     */
    protected AbstractOnlineHelpHierarchyBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractOnlineHelpHierarchyBlock) super.clone();
    }

    /**
     * Returns the primary key of the home article. Overrides
     * AbstractArticleHierarchyBlock.getHomeArticlePrimaryKey.
     * 
     * 
     * 
    ...
    public void printBodyWithoutAuthenticationCheck() {
         ...
         * print the body
         */
        aw.printHierarchyHTML(article, this.getHomeArticlePrimaryKey(), this,
                true);
    }
}

// end AbstractOnlineHelpHierarchyBlock
