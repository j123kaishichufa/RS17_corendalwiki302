...
/**
 * AbstractImageNewBlock is the abstract block creating a new article through a
 * form.
 * 
 * @version $Id: AbstractImageNewBlock.java,v 1.1 2005/09/06 21:25:28 tdanard
 *          Exp $
 */
public abstract class AbstractImageNewBlock extends AbstractImageEntryBlock
     ...
     */
    protected AbstractImageNewBlock() {
        // parent class constructor is called
    }

    /**
     * Returns a clone. Overrides AbstractImageEntryBlock.clone.
     */
    @Override
    public Object clone() {
        return (AbstractImageNewBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        ...
        /*
         * get the add image upload page
         */
        PrimaryKey pagePk = PrimaryKeyUtil
                .getAlphanumericSingleKey(PagesDictionary.UPLOAD_IMAGE_TO_ADD);
