...
/**
 * AbstractImageAccessGroupsViewBlock is the class describing and printing the
 * lkist of image subscribers.
 * 
 * @version $Id: AbstractImageAccessGroupsViewBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractImageAccessGroupsViewBlock extends
     ...
     */
    protected AbstractImageAccessGroupsViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractImageAccessGroupsViewBlock) super.clone();
    }
...
// end AbstractImageAccessGroupsViewBlock
