...
/**
 * AbstractArticleWhatsRelatedViewBlock is the class describing and printing all
 * content requests of a requestor.
 * 
 * @version $Id: AbstractArticleWhatsRelatedViewBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractArticleWhatsRelatedViewBlock extends
     ...
     */
    protected AbstractArticleWhatsRelatedViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleWhatsRelatedViewBlock) super.clone();
    }
    ...
    protected List getContentsFound() {
        ...
        /*
         * get the list of related content
         */
        List<StandardContent> result;
        if (article != null) {
            result = scf.findEnabledByParentArticlePrimaryKey(article
                    .getPrimaryKey());
        } else {
            return new ArrayList<StandardContent>();
        }
...
// end AbstractArticleWhatsRelatedViewBlock
