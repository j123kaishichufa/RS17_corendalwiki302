...
/**
 * ResourceRequestTypeElements is the class storing all content request type
 * element names.
 * 
 * @version $Id: ContentRequestTypeElements.java,v 1.1 2005/09/06 21:25:29
 *          tdanard Exp $
 */

public class ContentRequestTypeElements {
    /** Name of the collection element. */
    public static final String COLLECTION = "contentrequesttypes";

    /** Name of the entity element. */
    public static final String ENTITY = "contentrequesttype";
     ...
     */
    private ContentRequestTypeElements() {
