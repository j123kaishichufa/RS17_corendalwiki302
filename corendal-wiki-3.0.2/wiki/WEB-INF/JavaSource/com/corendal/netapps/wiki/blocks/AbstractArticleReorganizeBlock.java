...
/**
 * AbstractArticleReorganizeBlock is the abstract block creating a new Article
 * through a form.
 * 
 * @version $Id: AbstractArticleReorganizeBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractArticleReorganizeBlock extends
     ...
     */
    protected AbstractArticleReorganizeBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleReorganizeBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        /*
         * initialize the article entry block
         */
    ...
    public void validateExtra() throws IOException {
        this.validateExtraReorganizeArticle();
    }
}

// end AbstractArticleReorganizeBlock
