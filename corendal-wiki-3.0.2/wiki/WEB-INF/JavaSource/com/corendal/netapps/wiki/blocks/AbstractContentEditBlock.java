...
/**
 * AbstractContentEditBlock is the abstract block creating a new Content through
 * a form.
 * 
 * @version $Id: AbstractContentEditBlock.java,v 1.1 2005/09/06 21:25:28 tdanard
 *          Exp $
 */
public abstract class AbstractContentEditBlock extends
        AbstractContentEntryBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead.
     */
    protected AbstractContentEditBlock() {
        // parent class constructor is called
    }

    /**
     * Returns a clone. Overrides AbstractContentEntryBlock.clone.
     */
    @Override
    public Object clone() {
        return (AbstractContentEditBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        ...
        if (sp != null) {
             ...
             */
            if (resm.getIsRequestRequirementWaived(sa.getPrimaryKey(), sp
                    .getPrimaryKey())) {
