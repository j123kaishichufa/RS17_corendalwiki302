...
/**
 * ResourceClassificationTypeElements is the class storing all content
 * classification type element names.
 * 
 * @version $Id: ContentClassificationTypeElements.java,v 1.1 2005/09/06
 *          21:25:29 tdanard Exp $
 */

public class ContentClassificationTypeElements {
    /** Name of the collection element. */
    public static final String COLLECTION = "contentclassificationtypes";

    /** Name of the entity element. */
    public static final String ENTITY = "contentclassificationtype";
     ...
     */
    private ContentClassificationTypeElements() {
