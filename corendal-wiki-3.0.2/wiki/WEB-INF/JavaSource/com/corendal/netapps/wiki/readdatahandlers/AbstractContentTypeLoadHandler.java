...
import com.corendal.netapps.wiki.readdataelements.ContentTypeElements;

/**
 * AbstractContentTypeLoadHandler is the abstract class processing XML entities
 * representing a content type found after a load query.
 * 
 * @version $Id: AbstractContentTypeLoadHandler.java,v 1.1 2005/09/06 21:25:33
 *          tdanard Exp $
 */
public abstract class AbstractContentTypeLoadHandler extends
        AbstractLoadHandler implements ContentTypeLoadHandler {
    /** Name in the content type XML entity. */
    private StringBuilder name;

    /** Description in the content type XML entity. */
    private StringBuilder description;

    /** Comment in the content type XML entity. */
    private StringBuilder comment;

    /** Order in the content type XML entity. */
    private int order;

    /** Enabled-flag in the content type XML entity. */
     ...
     */
    protected AbstractContentTypeLoadHandler() {
        // parent class constructor is called
    }

    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentTypeLoadHandler#getName()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentTypeLoadHandler#getDescription()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentTypeLoadHandler#getComment()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentTypeLoadHandler#getOrder()
     */
    public int getOrder() {
        return this.order;
    }
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentTypeLoadHandler#getEnabledFlag()
     */
    ...
    protected void processElement(String namespaceUri, String localName,
        ...
        super.processElement(namespaceUri, localName, qualifiedName,
                attributes, isStart);
        if (qualifiedName.equals(ContentTypeElements.ENTITY)) {
            if (isStart) {
                this.enabledFlag = this.getStringAttributeValue(attributes,
                        ContentTypeElements.ENABLED_FLAG);
                this.order = this.getIntegerAttributeValue(attributes,
                        ContentTypeElements.ORDER);
            }
        } else if (qualifiedName.equals(ContentTypeElements.NAME)) {
            this.isNameCollected = isStart;
        } else if (qualifiedName.equals(ContentTypeElements.DESCRIPTION)) {
            this.isDescriptionCollected = isStart;
        } else if (qualifiedName.equals(ContentTypeElements.COMMENT)) {
