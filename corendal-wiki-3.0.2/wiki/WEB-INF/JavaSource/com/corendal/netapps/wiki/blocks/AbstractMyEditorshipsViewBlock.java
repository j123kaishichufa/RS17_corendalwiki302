...
/**
 * AbstractMyEditorshipsViewBlock is the class describing and printing all
 * articles of an editor.
 * 
 * @version $Id: AbstractMyEditorshipsViewBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractMyEditorshipsViewBlock extends
     ...
     */
    protected AbstractMyEditorshipsViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractMyEditorshipsViewBlock) super.clone();
    }
    ...
    protected List getContentsFound() {
        ...
        PrimaryKey editorPk = sa.getPrimaryKey();
        ...
        if (editorPk != null) {
            articlesFound = sdf.findEnabledByEditorPrimaryKey(editorPk);
        } else {
...
// end AbstractMyEditorshipsViewBlock
