...
/**
 * AbstractImageSubscriptionRemoveBlock is the abstract block creating a new
 * article through a form.
 * 
 * @version $Id: AbstractImageSubscriptionRemoveBlock.java,v 1.1 2005/09/06
 *          21:25:27 tdanard Exp $
 */
public abstract class AbstractImageSubscriptionRemoveBlock extends
     ...
     */
    protected AbstractImageSubscriptionRemoveBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractImageSubscriptionRemoveBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        ...
        if (sd != null) {
             ...
             */
            StandardAccount editor = parentArticle.getEditorStandardAccount();
...
// end AbstractImageSubscriptionRemoveBlock
