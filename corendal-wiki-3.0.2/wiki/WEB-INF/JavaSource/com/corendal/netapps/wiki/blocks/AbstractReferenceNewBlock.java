...
/**
 * AbstractReferenceNewBlock is the abstract block creating a new reference
 * through a form.
 * 
 * @version $Id: AbstractReferenceNewBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractReferenceNewBlock extends
        AbstractReferenceEntryBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead.
     */
    protected AbstractReferenceNewBlock() {
        // parent class constructor is called
    }

    /**
     * Returns a clone. Overrides AbstractReferenceEntryBlock.clone.
     */
    @Override
    public Object clone() {
        return (AbstractReferenceNewBlock) super.clone();
    }
