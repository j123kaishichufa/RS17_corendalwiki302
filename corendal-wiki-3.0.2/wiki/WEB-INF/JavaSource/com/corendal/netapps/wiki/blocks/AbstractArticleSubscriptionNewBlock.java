...
/**
 * AbstractArticleSubscriptionNewBlock is the abstract block creating a new
 * article through a form.
 * 
 * @version $Id: AbstractArticleSubscriptionNewBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractArticleSubscriptionNewBlock extends
     ...
     */
    protected AbstractArticleSubscriptionNewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleSubscriptionNewBlock) super.clone();
    }
...
// end AbstractArticleSubscriptionNewBlock
