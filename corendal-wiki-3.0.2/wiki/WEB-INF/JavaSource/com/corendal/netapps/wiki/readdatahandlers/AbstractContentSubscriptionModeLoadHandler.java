...
import com.corendal.netapps.wiki.readdataelements.ContentSubscriptionModeElements;

/**
 * AbstractResourceSubscriptionModeLoadHandler is the abstract class processing
 * XML entities representing a content subscription mode found after a load
 * query.
 * 
 * @version $Id: AbstractContentSubscriptionModeLoadHandler.java,v 1.1
 *          2005/09/06 21:25:33 tdanard Exp $
 */
public abstract class AbstractContentSubscriptionModeLoadHandler extends
        AbstractLoadHandler implements ContentSubscriptionModeLoadHandler {
    /** Name in the content subscription mode XML entity. */
    private StringBuilder name;

    /** Description in the content subscription mode XML entity. */
    private StringBuilder description;

    /** Comment in the content subscription mode XML entity. */
    private StringBuilder comment;

    /** Order in the content subscription mode XML entity. */
    private int order;

    /** Enabled-flag in the content subscription mode XML entity. */
     ...
     */
    protected AbstractContentSubscriptionModeLoadHandler() {
        // parent class constructor is called
    }

    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionModeLoadHandler#getName()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionModeLoadHandler#getDescription()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionModeLoadHandler#getComment()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionModeLoadHandler#getOrder()
     */
    public int getOrder() {
        return this.order;
    }
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentSubscriptionModeLoadHandler#getEnabledFlag()
     */
    ...
    protected void processElement(String namespaceUri, String localName,
        ...
        super.processElement(namespaceUri, localName, qualifiedName,
                attributes, isStart);
        if (qualifiedName.equals(ContentSubscriptionModeElements.ENTITY)) {
            if (isStart) {
                this.enabledFlag = this.getStringAttributeValue(attributes,
                        ContentSubscriptionModeElements.ENABLED_FLAG);
                this.order = this.getIntegerAttributeValue(attributes,
                        ContentSubscriptionModeElements.ORDER);
            }
        } else if (qualifiedName.equals(ContentSubscriptionModeElements.NAME)) {
            this.isNameCollected = isStart;
        } else if (qualifiedName
                .equals(ContentSubscriptionModeElements.DESCRIPTION)) {
            this.isDescriptionCollected = isStart;
        } else if (qualifiedName
                .equals(ContentSubscriptionModeElements.COMMENT)) {
