...
/**
 * AbstractArticleHierarchyBlock is the class describing and printing all
 * contents of an article.
 * 
 * @version $Id: AbstractArticleHierarchyBlock.java,v 1.1 2005/09/06 21:25:27
 *          tdanard Exp $
 */
public abstract class AbstractArticleHierarchyBlock extends
     ...
     */
    protected AbstractArticleHierarchyBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleHierarchyBlock) super.clone();
    }
...
// end AbstractArticleHierarchyBlock
