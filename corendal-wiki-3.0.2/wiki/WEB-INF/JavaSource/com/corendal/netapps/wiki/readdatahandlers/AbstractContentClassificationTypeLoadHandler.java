...
import com.corendal.netapps.wiki.readdataelements.ContentClassificationTypeElements;

/**
 * AbstractContentClassificationTypeLoadHandler is the abstract class processing
 * XML entities representing a content classification type found after a load
 * query.
 * 
 * @version $Id: AbstractContentClassificationTypeLoadHandler.java,v 1.1
 *          2005/09/06 21:25:33 tdanard Exp $
 */
public abstract class AbstractContentClassificationTypeLoadHandler extends
        AbstractLoadHandler implements ContentClassificationTypeLoadHandler {
    /** Name in the content classification type XML entity. */
    private StringBuilder name;

    /** Description in the content classification type XML entity. */
    private StringBuilder description;

    /** Comment in the content classification type XML entity. */
    private StringBuilder comment;

    /** Order in the content classification type XML entity. */
    private int order;

    /** Enabled-flag in the content classification type XML entity. */
     ...
     */
    protected AbstractContentClassificationTypeLoadHandler() {
        // parent class constructor is called
    }

    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentClassificationTypeLoadHandler#getName()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentClassificationTypeLoadHandler#getDescription()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentClassificationTypeLoadHandler#getComment()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentClassificationTypeLoadHandler#getOrder()
     */
    public int getOrder() {
        return this.order;
    }
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentClassificationTypeLoadHandler#getEnabledFlag()
     */
    ...
    protected void processElement(String namespaceUri, String localName,
        ...
        super.processElement(namespaceUri, localName, qualifiedName,
                attributes, isStart);
        if (qualifiedName.equals(ContentClassificationTypeElements.ENTITY)) {
            if (isStart) {
                this.enabledFlag = this.getStringAttributeValue(attributes,
                        ContentClassificationTypeElements.ENABLED_FLAG);
                this.order = this.getIntegerAttributeValue(attributes,
                        ContentClassificationTypeElements.ORDER);
            }
        } else if (qualifiedName.equals(ContentClassificationTypeElements.NAME)) {
            this.isNameCollected = isStart;
        } else if (qualifiedName
                .equals(ContentClassificationTypeElements.DESCRIPTION)) {
            this.isDescriptionCollected = isStart;
        } else if (qualifiedName
                .equals(ContentClassificationTypeElements.COMMENT)) {
