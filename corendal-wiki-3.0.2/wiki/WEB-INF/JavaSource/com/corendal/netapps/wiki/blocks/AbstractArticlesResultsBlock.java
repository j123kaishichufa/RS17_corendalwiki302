...
/**
 * AbstractArticlesResultsBlock is the class describing and printing all
 * articles used in the application.
 * 
 * @version $Id: AbstractArticlesResultsBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractArticlesResultsBlock extends
     ...
     */
    protected AbstractArticlesResultsBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticlesResultsBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
        ...
        if (this.getIsBodyPrinted()) {
            for (int i = 0; i < articlesFound.size(); i++) {
                 ...
                 */
                Searched classificationSearched = currentArticle
                 ...
                 */
                Date modifiedDate = currentArticle.getLastEntryLogTimestamp();
                 ...
                 */
                StandardIcon previewIcon = ContentUtil.getDirectPreviewIcon(
    ...
    /**
     * Returns the list of content articles to print.
     * 
     * 
     * 
...
// end AbstractArticlesResultsBlock
