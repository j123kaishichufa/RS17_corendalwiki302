...
import com.corendal.netapps.wiki.readdatabeans.AbstractContentRequestType;

/**
 * AbstractStandardContentRequestType is the abstract class handling information
 * about each role of the application.
 * 
 * @version $Id: AbstractStandardContentRequestType.java,v 1.1 2005/09/06
 *          21:25:34 tdanard Exp $
 */
public abstract class AbstractStandardContentRequestType extends
        AbstractContentRequestType implements Cloneable,
        StandardContentRequestType {
     ...
     * 
     */
    protected AbstractStandardContentRequestType() {
        // no initialization required
    }

    /**
     * Returns a clone. Overrides AbstractContentRequestType.clone.
     */
    @Override
    public Object clone() {
        return (AbstractStandardContentRequestType) super.clone();
    }
    ...
    public String getRelativeLocation() {
        return EntityUtil
                .getRelativeLocation(
                        ...
                        HTTPParameterConstants.CONTENT_REQUEST_TYPE_ID, this
...
// end AbstractStandardContentRequestType
