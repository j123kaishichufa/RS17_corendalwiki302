...
import com.corendal.netapps.wiki.readdataelements.ContentRuleTypeElements;

/**
 * AbstractContentRuleTypeLoadHandler is the abstract class processing XML
 * entities representing a content rule type found after a load query.
 * 
 * @version $Id: AbstractContentRuleTypeLoadHandler.java,v 1.1 2005/09/06
 *          21:25:33 tdanard Exp $
 */
public abstract class AbstractContentRuleTypeLoadHandler extends
        AbstractLoadHandler implements ContentRuleTypeLoadHandler {
    /** Name in the content rule type XML entity. */
    private StringBuilder name;

    /** Description in the content rule type XML entity. */
    private StringBuilder description;

    /** Comment in the content rule type XML entity. */
    private StringBuilder comment;

    /** Order in the content rule type XML entity. */
    private int order;

    /** Enabled-flag in the content rule type XML entity. */
     ...
     */
    protected AbstractContentRuleTypeLoadHandler() {
        // parent class constructor is called
    }

    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleTypeLoadHandler#getName()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleTypeLoadHandler#getDescription()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleTypeLoadHandler#getComment()
     */
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleTypeLoadHandler#getOrder()
     */
    public int getOrder() {
        return this.order;
    }
    ...
    /*
     * @see com.corendal.netapps.wiki.interfaces.ContentRuleTypeLoadHandler#getEnabledFlag()
     */
    ...
    protected void processElement(String namespaceUri, String localName,
        ...
        super.processElement(namespaceUri, localName, qualifiedName,
                attributes, isStart);
        if (qualifiedName.equals(ContentRuleTypeElements.ENTITY)) {
            if (isStart) {
                this.enabledFlag = this.getStringAttributeValue(attributes,
                        ContentRuleTypeElements.ENABLED_FLAG);
                this.order = this.getIntegerAttributeValue(attributes,
                        ContentRuleTypeElements.ORDER);
            }
        } else if (qualifiedName.equals(ContentRuleTypeElements.NAME)) {
            this.isNameCollected = isStart;
        } else if (qualifiedName.equals(ContentRuleTypeElements.DESCRIPTION)) {
            this.isDescriptionCollected = isStart;
        } else if (qualifiedName.equals(ContentRuleTypeElements.COMMENT)) {
