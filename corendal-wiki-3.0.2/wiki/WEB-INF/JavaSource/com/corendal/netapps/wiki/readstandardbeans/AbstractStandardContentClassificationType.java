...
/**
 * AbstractStandardContentClassificationType is the abstract class handling
 * information about each content classification type of the application.
 * 
 * @version $Id: AbstractStandardContentClassificationType.java,v 1.1 2005/09/06
 *          21:25:34 tdanard Exp $
 */
public abstract class AbstractStandardContentClassificationType extends
        AbstractContentClassificationType implements Cloneable,
        StandardContentClassificationType {
     ...
     * 
     */
    protected AbstractStandardContentClassificationType() {
        // no initialization required
    }

    /**
     * Returns a clone. Overrides AbstractContentClassificationType.clone.
     */
    @Override
    public Object clone() {
        return (AbstractStandardContentClassificationType) super.clone();
    }
    ...
    public String getRelativeLocation() {
        return EntityUtil
                .getRelativeLocation(
                        ...
                        HTTPParameterConstants.CONTENT_CLASSIFICATION_TYPE_ID,
...
// end AbstractStandardContentClassificationType
