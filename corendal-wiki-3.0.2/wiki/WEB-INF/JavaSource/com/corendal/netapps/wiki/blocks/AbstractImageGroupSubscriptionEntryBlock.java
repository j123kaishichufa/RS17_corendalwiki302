...
/**
 * AbstractImageGroupSubscriptionEntryBlock is the parent block common to all
 * image viewing blocks.
 * 
 * @version $Id: AbstractImageGroupSubscriptionEntryBlock.java,v 1.1 2005/09/06
 *          21:25:27 tdanard Exp $
 */
public abstract class AbstractImageGroupSubscriptionEntryBlock extends
        AbstractCommonContentEntryBlock implements Cloneable {
    /** Fully qualified name of this class. */
    private static final String ABSTRACT_CLASS_NAME = "com.corendal.netapps.wiki.blocks.AbstractImageGroupSubscriptionEntryBlock";
     ...
     */
    protected AbstractImageGroupSubscriptionEntryBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractImageGroupSubscriptionEntryBlock) super.clone();
    }
    ...
    private void build() {
        ...
        if (this.getAccessType().equals(AccessTypeConstants.NEW)) {
            ...
            List<StandardGroup> subscribersToRemove = ContentUtil
                    .getGroupsLeftToUnsubscribeByEditor(imagePk);
        ...
        if ((image.getIsFound()) && (image.getIsVisible())) {
            ...
            if (resm.getIsRequestRequirementWaived(sa.getPrimaryKey(),
                ...
                PrimaryKey notAllowedPk = PrimaryKeyUtil
                        .getAlphanumericSingleKey(MessagesDictionary.ERR_ONLY_EDITOR_CAN_EDIT_IMAGE_GROUP_SUBSCRIPTIONS);
            ...
            if (resm.getIsRequestRequirementWaived(sa.getPrimaryKey(),
                ...
                if (values.size() > 0) {
                    ...
                    PrimaryKey noGroupSubscriberPk = PrimaryKeyUtil
                            .getAlphanumericSingleKey(MessagesDictionary.ERR_NO_GROUP_IMAGE_SUBSCRIBER);
                    ...
                    StandardMessage noGroupSubscriberMessage = noGroupSubscriber
                            .getStandardMessage();
                    noGroupSubscriberMessage.replaceMessageText(image
                            .getNameText(), 1);
                    noGroupSubscriberMessage.replaceMessageEncoded(image
                            .getNameEncoded(), 1);
                    noGroupSubscriberMessage.replaceMessageHTML(image
                            .getNameHTML(), 1);
    ...
    public void validateExtraNewRecord() throws IOException {
        ...
        if (this.getIsValid()) {
            ...
            if (content.getIsDirectlySubscribedByGroup(subscriberPk)) {
                 ...
                 */
                PrimaryKey errorPk = PrimaryKeyUtil
                        .getAlphanumericSingleKey(MessagesDictionary.ERR_GROUP_ALREADY_IMAGE_SUBSCRIBER);
                StandardMessage error = (StandardMessage) smf
                        .findByPrimaryKey(errorPk);
        ...
        if (this.getIsValid()) {
            ...
            contentSubscription = (StandardContentSubscription) srsf.create(
                    image.getPrimaryKey(), groupTypesPk, immediateModePk);
    ...
    public void validateExtraRemoveRecord() throws IOException {
        ...
        if (this.getIsValid()) {
            ...
            if (!(content.getIsDirectlySubscribedByGroup(subscriberPk))) {
                 ...
                 */
                PrimaryKey errorPk = PrimaryKeyUtil
                        .getAlphanumericSingleKey(MessagesDictionary.ERR_NOT_GROUP_IMAGE_SUBSCRIBER);
                StandardMessage error = (StandardMessage) smf
                        .findByPrimaryKey(errorPk);
        ...
        if (this.getIsValid()) {
            List<StandardContentSubscription> contentSubscriptions = srsf
                    .findEnabledByContentAndGroupSubscriberPrimaryKeys(image
...
// end AbstractImageGroupSubscriptionEntryBlock
