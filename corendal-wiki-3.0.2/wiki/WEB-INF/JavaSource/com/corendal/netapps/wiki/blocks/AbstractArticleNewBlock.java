...
/**
 * AbstractArticleNewBlock is the abstract block creating a new article through
 * a form.
 * 
 * @version $Id: AbstractArticleNewBlock.java,v 1.1 2005/09/06 21:25:28 tdanard
 *          Exp $
 */
public abstract class AbstractArticleNewBlock extends AbstractArticleEntryBlock
     ...
     */
    protected AbstractArticleNewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleNewBlock) super.clone();
    }
    ...
    public void initStandardBlock() {
         ...
         */
        StandardArticle sd = getViewedArticle();
        ...
        if (sd != null) {
             ...
             */
            this.setFirstTimeAuthor(AccountUtil
                    .getCurrentFullNameAndLoginText());
            this.setFirstTimeEditor(AccountUtil
                    .getCurrentFullNameAndLoginText());
            this
                    .setFirstTimeClassificationType(ContentClassificationTypesDictionary.SAME_AS_PARENT);

            /*
             * set the default approval flag
             */
            if (resm.getIsRequestRequirementWaived(sa.getPrimaryKey(), sd
                    .getPrimaryKey())) {
                this.setFirstTimeApproveRequest("Y");
            }

            /*
             * set the default friendly address
             */
            String friendlyAddress = this.getRequestedFriendlyAddress();

            if (!(StringUtil.getIsEmpty(friendlyAddress))) {
                this.setFirstTimeFriendlyAddress(friendlyAddress);
            }

            /*
             * set the default name
             */
            String name = this.getRequestedName();
            if (!(StringUtil.getIsEmpty(name))) {
                this.setFirstTimeName(name);
            }
        }
    ...
    /**
     * Returns the requested friendly address.
     * 
     * 
     * 
     * @return a java.lang.String object
     */
    public String getRequestedFriendlyAddress() {
        /*
         * get the managers used in this procedure
         */
        ManagerSet pms = AnyLogicContextGlobal.get().getManagerSet();
         ...
         * return
         */
        return rm.getParameter(HTTPParameterConstants.FRIENDLY_ADDRESS);
    }
    ...
    public String getRequestedName() {
         ...
         * return
         */
        return rm.getParameter(HTTPParameterConstants.NAME);
    }
