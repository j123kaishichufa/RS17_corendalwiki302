...
/**
 * AbstractArticleVersionsViewBlock is the class describing and printing all
 * article versions used in the application.
 * 
 * @version $Id: AbstractArticleVersionsViewBlock.java,v 1.1 2005/09/06 21:25:28
 *          tdanard Exp $
 */
public abstract class AbstractArticleVersionsViewBlock extends
        AbstractArticleVersionResultsBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead
     */
    protected AbstractArticleVersionsViewBlock() {
        // parent class constructor is called
    }

    /**
     * Returns a clone. Overrides AbstractArticleVersionResultsBlock.clone.
     */
    @Override
    public Object clone() {
        return (AbstractArticleVersionsViewBlock) super.clone();
    }

    /**
     * Returns the list of article versions to print. Overrides
     * AbstractArticleVersionResultsBlock.getArticleVersionsFound.
     * 
     * 
     * 
    ...
    protected List getArticleVersionsFound() {
        ...
        if ((article != null) && (article.getIsFound())) {
            articleVersionsFound = sdvf.findEnabledByArticlePrimaryKey(article
                    .getPrimaryKey());
        } else {
...
// end AbstractArticleVersionsViewBlock
