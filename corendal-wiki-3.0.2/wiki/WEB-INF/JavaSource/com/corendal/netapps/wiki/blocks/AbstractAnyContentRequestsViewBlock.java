...
/**
 * AbstractAnyContentRequestsViewBlock is the class describing and printing all
 * content requests of a requestor.
 * 
 * @version $Id: AbstractAnyContentRequestsViewBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractAnyContentRequestsViewBlock extends
     ...
     */
    protected AbstractAnyContentRequestsViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractAnyContentRequestsViewBlock) super.clone();
    }
    ...
    protected List getContentRequestsFound() {
        ...
        if (requestorPk != null) {
            contentRequestsFound = srf
                    .findEnabledByRequestorPrimaryKey(requestorPk);
        } else {
            contentRequestsFound = new ArrayList<StandardContentRequest>();
        }

        /*
         * remove the content requests that the current user cannot see
         */
        List<StandardContentRequest> filteredContentRequestsFound = new ArrayList<StandardContentRequest>();

        for (StandardContentRequest currentContentRequest : contentRequestsFound) {

            if (currentContentRequest.getIsVisible()) {
                filteredContentRequestsFound.add(currentContentRequest);
            }
        }
         ...
         * return
         */
        return filteredContentRequestsFound;
    }
...
// end AbstractAnyContentRequestsViewBlock
