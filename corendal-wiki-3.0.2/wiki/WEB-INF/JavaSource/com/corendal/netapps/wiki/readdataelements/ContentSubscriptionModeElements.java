...
/**
 * ResourceSubscriptionModeElements is the class storing all content
 * subscription mode element names.
 * 
 * @version $Id: ContentSubscriptionModeElements.java,v 1.1 2005/09/06 21:25:29
 *          tdanard Exp $
 */

public class ContentSubscriptionModeElements {
    /** Name of the collection element. */
    public static final String COLLECTION = "contentsubscriptionmodes";

    /** Name of the entity element. */
    public static final String ENTITY = "contentsubscriptionmode";
     ...
     */
    private ContentSubscriptionModeElements() {
