...
/**
 * AbstractArticleEditBlock is the abstract block creating a new Article through
 * a form.
 * 
 * @version $Id: AbstractArticleEditBlock.java,v 1.1 2005/09/06 21:25:28 tdanard
 *          Exp $
 */
public abstract class AbstractArticleEditBlock extends
     ...
     */
    protected AbstractArticleEditBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractArticleEditBlock) super.clone();
    }
