...
/**
 * AbstractAnySubscriptionsViewBlock is the class describing and printing all
 * subscriptions for the current user.
 * 
 * @version $Id: AbstractAnySubscriptionsViewBlock.java,v 1.1 2005/09/06
 *          21:25:27 tdanard Exp $
 */
public abstract class AbstractAnySubscriptionsViewBlock extends
     ...
     */
    protected AbstractAnySubscriptionsViewBlock() {
    ...
    @Override
    public Object clone() {
        return (AbstractAnySubscriptionsViewBlock) super.clone();
    }
...
// end AbstractAnySubscriptionsViewBlock
