...
import com.corendal.netapps.wiki.readdatabeans.AbstractContentSubscriptionType;

/**
 * AbstractStandardContentSubscriptionType is the abstract class handling
 * information about each content classification type of the application.
 * 
 * @version $Id: AbstractStandardContentSubscriptionType.java,v 1.1 2005/09/06
 *          21:25:34 tdanard Exp $
 */
public abstract class AbstractStandardContentSubscriptionType extends
        AbstractContentSubscriptionType implements Cloneable,
        StandardContentSubscriptionType {
     ...
     * 
     */
    protected AbstractStandardContentSubscriptionType() {
        // no initialization required
    }

    /**
     * Returns a clone. Overrides AbstractContentSubscriptionType.clone.
     */
    @Override
    public Object clone() {
        return (AbstractStandardContentSubscriptionType) super.clone();
    }
    ...
    public String getRelativeLocation() {
        return EntityUtil
                .getRelativeLocation(
                        ...
                        HTTPParameterConstants.CONTENT_SUBSCRIPTION_TYPE_ID,
...
// end AbstractStandardContentSubscriptionType
