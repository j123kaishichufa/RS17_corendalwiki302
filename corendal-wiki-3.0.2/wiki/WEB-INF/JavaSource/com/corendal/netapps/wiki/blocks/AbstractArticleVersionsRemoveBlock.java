...
/**
 * AbstractArticleVersionsRemoveBlock is the abstract block creating a new
 * Content through a form.
 * 
 * @version $Id: AbstractArticleVersionsRemoveBlock.java,v 1.1 2005/09/06
 *          21:25:28 tdanard Exp $
 */
public abstract class AbstractArticleVersionsRemoveBlock extends
        AbstractArticleVersionEntryBlock implements Cloneable {
    /**
     * Default class constructor. This procedure is protected to force the usage
     * of the findBy methods. The creation of new instances is too consuming
     * when caching and cloning technics can be used instead.
     */
    protected AbstractArticleVersionsRemoveBlock() {
        // parent class constructor is called
    }

    /**
     * Returns a clone. Overrides AbstractArticleVersionEntryBlock.clone.
     */
    @Override
    public Object clone() {
        return (AbstractArticleVersionsRemoveBlock) super.clone();
    }
...
// end AbstractArticleVersionsRemoveBlock
